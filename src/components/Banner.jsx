    ...
    return (
        ...
        <div className="bannerHome h-screen flex-row font-spaceGrotesk">
            <div className="font-bold mt-5">
                <h1 className="md:text-5xl text-white">1st International Conference <br />On Sustainability of Sciences <br />for the Future ( ICSSF )</h1>
                <h1 className="text-darkGreen pt-5">September 26-27th, 2024</h1>
