...
const Footer = () => {
    return (
        <>
        <div className="flex items-center justify-between mx-10 py-5 mt-[10em] border-t border-white border-opacity-10">
            <img src={logoFooter} width={200}/>
            <p className="font-plusJakarta text-white text-sm">Copyright ICSSF 2024</p>
